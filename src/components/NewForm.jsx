        ...
        <div className="flex flex-col items-center justify-start gap-4 mb-4">
            ...
            >
              ...
              {!dateSelected ? (
                ...
                <DatePicker
                  ...
                  className="rounded-md border-none font-medium bg-transparent px-5 py-5 w-full"
                />
              )}
            </button>
          </div>
          {/* <div className="flex flex-wrap gap-2 mt-2">
            {tags.map((tag, index) => (
              <div
                key={index}
                className="bg-[#151515] px-3 py-1 rounded-full text-sm font-medium flex items-center"
              >
                {tag.label}
                <span
