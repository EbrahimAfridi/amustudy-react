        ...
        <div className={`${mobile ? mobileScreenStyle : wideScreenStyle}`}>
          ...
          <div className="flex flex-col gap-10 w-full pt-10 rounded-md px-4">
            {events.map((event, index) => (
              <div 
                key={index} 
                className="flex-col w-full text-[15px] sm:p-0 p-3 sm:border-0 border-[1px] border-gray-700 rounded-xl sm:cursor-auto cursor-pointer"
              ...
              >
                <div className="flex sm:flex-col flex-row sm:justify-center justify-between gap-2">
                  ...
                  <div className='w-1/2 sm:w-fit'>  
                    <h3 className=" sm:font-medium font-bold sm:text-[17px] text-[20px] sm:cursor-pointer pb-1">{event.title}</h3>
